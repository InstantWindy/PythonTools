...
if __name__ == '__main__':
    time_start = time.time()
        ...
        # orignal image path
    origion_path = '../data/dataset_ball/'
    gun_train_dir = '../data/dataset_guns/train/'
    gun_test_dir = '../data/dataset_guns/test/'

    # save path
    save_train_dir = '../data/dataset_balls/train/'
    save_test_dir = '../data/dataset_balls/test/'
    ...
    # # orignal image path
    # origion_path = '../data/dataset_gun/'

    # # save path
    # save_train_dir = '../data/dataset_s/train/'
    # save_test_dir = '../data/dataset_guns/test/'
    # save_dir = [save_train_dir, save_test_dir]
    # for dirs in save_dir:
    #     if not os.path.exists(dirs):
    #         os.makedirs(dirs)
